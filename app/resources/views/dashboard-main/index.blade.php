...
@push('styles')
<link rel="stylesheet" href="{{ asset('dashboard-main/css/main.css') }}">
@endpush
...
const goalsIndexRoute = "{{ route('dashboard.goals.index') }}";
const goalsStoreRoute = "{{ route('dashboard.goals.store') }}";
const goalsBaseUrl = "{{ url('/dashboard/goals') }}";
const aiInsightRoute = "{{ route('dashboard.ai.insight') }}";
...
<script src="{{ asset('dashboard-main/js/goals.js') }}"></script>
<script src="{{ asset('dashboard-main/js/charts.js') }}"></script>
@endpush
