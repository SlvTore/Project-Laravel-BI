...
class SafeMathServiceTest extends TestCase
{
    ...
    public function test_safe_division_with_valid_numbers()
    {
        ...
        $this->assertEquals(2.3333333333333, $result, '', 0.0001);
    }
    ...
    public function test_validate_numeric_function()
    {
        ...
        $this->assertEquals(0.0, SafeMathService::validateNumeric(null));
        $this->assertEquals(999.0, SafeMathService::validateNumeric(null, 999));
